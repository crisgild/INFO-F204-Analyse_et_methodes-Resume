...
\begin{document}
    ...
    \input{7.test/text}
    \input{8.etude_de_cas/text}
    \input{9.design_issues/text}
    \input{10.distribution/text}
    \input{questions-reponses/1.cycle_de_vie/text}
    \input{questions-reponses/2.oop/text}
    \input{questions-reponses/3.uml/text}
    \input{questions-reponses/4.exigence/text}
    \input{questions-reponses/5.test/text}
    \input{questions-reponses/6.conception/text}
    \input{questions-reponses/7.pattern/text}
