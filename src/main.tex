...
\fancyfoot[L]{Open source pour ajout ou modification: https://github.com/Rodriguevb/INFOF204-Analyse\_et\_methodes-Resume/} % Numéro de page en bas de page à gauche
...
\pdfinfo{
    ...
    /Creator  (https://github.com/Rodriguevb/INFOF204-Analyse_et_methodes-Resume/)
}
