...
\begin{center}
    \color[rgb]{0,0.48,0.58}
%    \includegraphics[width=0.30\textwidth]{questions-reponses/3.uml/tourDeHanoiSequence.pdf}		ces fichiers ne sont pas dispo, commentaire jusqu'à trouver ces fichiers ou les créer
